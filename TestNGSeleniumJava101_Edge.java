...
public class TestNGSeleniumJava101_Edge {
    ...
    public void setup() throws MalformedURLException {
        ...
        options.setCapability("platformName", "macOS Sierra");
 
        // LambdaTest-specific capabilities
        options.setCapability("lt:options", Map(
            "username", "aishwarya_kasar",
            "accessKey", "bikTUg4OgguCE8vccbWBq3NGNP9JIAu1ujp8xqWKG4W80UurBt",
        ...
        driver = new RemoteWebDriver(new URL("http://aishwarya_kasar:bikTUg4OgguCE8vccbWBq3NGNP9JIAu1ujp8xqWKG4W80UurBt@hub.lambdatest.com/wd/hub"), options);
